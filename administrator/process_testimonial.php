...
$arrInsert->company = addslashes($_POST['txt_companyname']);
 ...
 if ($image) 
  {
	...
	createThumbs("slideshowimages/","news_image/thumbs/",100,$imagename);
	$arrInsert->photo_name = $imagename;    
	}

$value = insert_table($arrInsert,'testimonials');
