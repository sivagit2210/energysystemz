	...
	public function __construct( $instanceName )
 	{
		...
		//$this->ToolbarSet = 'customtoolbarset';
/*$this->ToolbarSets["customtoolbarset"]=  array(
0 => array('Source','DocProps','-','Save','NewPage','Preview','-','Templates'),
1 => array('Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'),
2 => array('Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript')
);*/ 
